...
MSG_TEXT = 'בחר בשירות אותו תרצה לחבר להרחבת Fen'
...
def show_contact(msg=""):
    class ContactWindow(xbmcgui.WindowXMLDialog):
        ...
        def onClick(self, controlid):
            ...
            elif controlid == self.fen_connect_ad_button:
                self.close()
                # Open Fen All Debrid Authentication Window
                xbmc.executebuiltin('RunPlugin(plugin://plugin.video.fen/?mode=alldebrid.authenticate)')
