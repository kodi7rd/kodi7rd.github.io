...
fen_str, delete_str, search_str, hist_str, vid_str, mov_str, key_str = ls(32036), ls(32785), ls(32450), ls(32486), ls(32491), ls(32028), ls(32092)
...
def get_search_term(params):
	...
	query = params_query or dialog.input(fen_str)
	if not query: return
	query = unquote(query)
