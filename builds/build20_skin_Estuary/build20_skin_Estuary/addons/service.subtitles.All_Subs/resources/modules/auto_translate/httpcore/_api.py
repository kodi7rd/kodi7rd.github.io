...
def request(
    ...
    *,
    ...
    Arguments:
        ...
        url: The URL of the HTTP request. Either as an instance of `httpcore.URL`, or as str/bytes.
        ...
        extensions: A dictionary of optional extra information included on the request. Possible keys include `"timeout"`.
