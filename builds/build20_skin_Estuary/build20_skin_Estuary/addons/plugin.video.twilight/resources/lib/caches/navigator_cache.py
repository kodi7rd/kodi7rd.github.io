...
prop_dict = {'default': 'twilight_%s_default', 'edited': 'twilight_%s_edited', 'shortcut_folder': 'twilight_%s_shortcut_folder'}
timeout = 60
...
main_menu_items = {'RootList': {'name': 32457, 'iconImage': 'twilight', 'mode': 'navigator.main', 'action': 'RootList'},
