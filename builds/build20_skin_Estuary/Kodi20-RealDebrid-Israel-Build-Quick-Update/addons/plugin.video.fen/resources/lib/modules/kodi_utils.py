...
current_dbs = ('navigator.db', 'watched.db', 'favourites.db', 'views.db', 'traktcache4.db', 'maincache.db', 'metacache2.db', 'debridcache.db', 'providerscache2.db', 'subs.db')
#########################################
...
# KODI-RD-IL ADDITION - NEW CUSTOM LINE:
subs = translatePath(database_path_raw % current_dbs[9])
#########################################
