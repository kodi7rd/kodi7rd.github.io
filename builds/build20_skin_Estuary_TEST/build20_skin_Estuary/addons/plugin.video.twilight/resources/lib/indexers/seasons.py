	...
	def _process():
		...
		for item in season_data:
			try:
				...
				set_properties({'totalepisodes': string(episode_count), 'watchedprogress': string(progress), 'twilight.playcount': string(playcount),
								'twilight.extras_params': extras_params, 'twilight.options_params': options_params})
				if kodi_version >= 20:
