...
def main():
    ...
    file_title_map_github_link = "https://kodirealdebridisrael.github.io/build_guides_addon/assets/file_title_map.json"
    ...
    guides_directory_github_url = "https://kodirealdebridisrael.github.io/build_guides_addon/assets/guides/"
    ...
    while True:
        ...
        if menu_item_selected_index_number == -1:  # User cancelled the menu
            ...
            # Generate full url for guide .txt file. Example: https://kodirealdebridisrael.github.io/build_guides_addon/assets/guides/<filename>.txt
